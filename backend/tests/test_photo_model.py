...
def test_paid_photo_must_have_a_spoiler(db):
    db.add(_photo(is_paid=True, price_stars=10, has_spoiler=False))
...
def test_paid_photo_requires_a_price(db):
    db.add(_photo(is_paid=True, price_stars=None, has_spoiler=True))
