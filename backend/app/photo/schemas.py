...
original_file_path. Clients only ever get a photo `id` and fetch bytes
through the access-checked /photos/{id}/file route — the server disk
...
class PhotoOut(BaseModel):
    ...
    audience_type: str
    created_at: datetime
    # Whether *this* viewer can currently see the real photo — computed
    # per-request (see app/photo/access.py), not a stored column. Lets
