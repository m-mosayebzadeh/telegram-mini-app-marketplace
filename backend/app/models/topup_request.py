...
(see app/topup/router.py's approve endpoint). requested_photons/
photon_rate_at_request/requested_toman_amount are what the USER asked
...
class TopUpRequest(Base):
    ...
    requested_photons: Mapped[int] = mapped_column(Integer)
    photon_rate_at_request: Mapped[int] = mapped_column(Integer)
