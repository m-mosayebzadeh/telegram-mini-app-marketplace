...
type IconProps = {
  size?: number
  /** Only for behaviour a caller owns and the icon cannot know — mainly
   *  .ui-row-chevron, which mirrors a directional glyph under RTL.
   *  Never for colour: an icon takes currentColor from its parent. */
  className?: string
}

export function IconChat({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9">
      <path
...
export function IconPersonFallback({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9">
...
// "users" (Tabler Icons, MIT) — the admin panel's "کاربران" section,
// re-set to this file's strokeWidth convention like every other icon
// here.
...
export function IconShieldLock({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
...
export function IconHeart({ size = 24, filled = false, className }: IconProps & { filled?: boolean }) {
  if (filled) {
    return (
...
export function IconPin({ size = 24, filled = false, className }: IconProps & { filled?: boolean }) {
  if (filled) {
    return (
      <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none">
...
/** The close affordance on sheets and dialogs. An × drawn as two lines,
 *  not the multiplication glyph — a text character does not scale, align
 *  or take stroke width the way the rest of the set does. */
...
/** Sits at the end of a list row that leads somewhere. Mirrored under
 *  dir="rtl" by .ui-row-chevron — it points the way the page runs. */
...
export function IconSettings({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
      <path d="M10.3 3.8a1 1 0 0 1 1-.8h1.4a1 1 0 0 1 1 .8l.2 1.3a7 7 0 0 1 1.5.9l1.2-.5a1 1 0 0 1 1.2.4l.7 1.2a1 1 0 0 1-.2 1.3l-1 .8a7 7 0 0 1 0 1.7l1 .8a1 1 0 0 1 .2 1.3l-.7 1.2a1 1 0 0 1-1.2.4l-1.2-.5a7 7 0 0 1-1.5.9l-.2 1.3a1 1 0 0 1-1 .8h-1.4a1 1 0 0 1-1-.8l-.2-1.3a7 7 0 0 1-1.5-.9l-1.2.5a1 1 0 0 1-1.2-.4l-.7-1.2a1 1 0 0 1 .2-1.3l1-.8a7 7 0 0 1 0-1.7l-1-.8a1 1 0 0 1-.2-1.3l.7-1.2a1 1 0 0 1 1.2-.4l1.2.5a7 7 0 0 1 1.5-.9Z" />
...
/** The dark surface. A moon rather than a colored swatch: the choice is
 *  about the environment the app is being read in, not a brand color. */
...
/** Opens the share sheet / copies a profile link. */
...
/** The overflow menu. Three dots, vertical — the horizontal version is
 *  too easily read as an ellipsis in running text. */
...
export function IconCake({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v3" />
