...
interface PhotonAmountFieldProps {
  id: string
 ...
 *
 * Photon is the only amount stored anywhere (TopUpRequest.requested_photons);
 ...
 * divide evenly by the rate silently rounded to a Photon count nobody had
 * entered.
 *
 ...
 */
export function PhotonAmountField({ id, value, onChange, rate, label }: PhotonAmountFieldProps) {
